...
from dissector import parse_packet
from utils import split_every_n, join_root
...
def parse_trace(trace, protocol):
    ...
    for packet in trace['stream']:
        ...
        packet['type'] = get_type(packet['dissection'])
